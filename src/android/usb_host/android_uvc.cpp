...
typedef librealuvc::small_heap<frame, 2> frames_archive;
...
usbhost_get_descriptor(usbhost_device *pDevice, int descriptor_type, int descriptor_index) {
    int curr_index = 0;
