...
/* Creates a usbhost_device object for a USB device */
...
/* Creates a usbhost_device object for already open USB device */
struct usbhost_device *usb_device_new(const char *dev_name, int fd);

/* Returns the file descriptor for the usbhost_device */
